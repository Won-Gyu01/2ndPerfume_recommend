#모델경로 설정을 변경한 상태 필요하면 바꾸며 실행해야함
#최종 라즈베리파이 버전 코드 성공
import sys
import os
import cv2
...
# 모델 경로 설정 (YOLOv8)
#model_path = "home/jiwon/perfume/data/best.pt"
...
def load_and_prepare_data():
    data = pd.read_csv("/home/jiwon/perfume/data/preprocessing_perfumes_dataset1.csv", encoding='latin1')
